...
namespace CEB_BILL
{
    public partial class frm_dom_billrate : Form
    {
        ...
        double charge_181_30_infinity_if_above_60kWh = 45.00;
        ...
        private void frm_dom_billrate_Load(object sender, EventArgs e)
        {
            ...
            lbl_t2_5.Text = charge_181_30_infinity_if_above_60kWh.ToString();
            ...
            lbl_t2_10.Text = fixed_charge_181_infinity_if_above_60kWh.ToString();
