...
{   
    public partial class frm_dom_cal : Form
    {
        ...
        double charge_181_infinity_if_above_60kWh = 45.00;
        ...
        double fixed_charge_181_infinity_if_above_60kWh = 540.00;
                ...
                else if (units_consumed > 60)
                {
                   if(units_consumed <= 90)
                    ...
                    else if (units_consumed > 180)
                    {
                        ...
                        total_charge = charge_0_30 + charge_31_60 + charge_61_90 + charge_91_120 + charge_121_180 + charge_above_180 + fixed_charge_181_infinity_if_above_60kWh;
