...
namespace CEB_BILL
{
    public partial class frm_rel_cat_R_1 : Form
    {
        ...
        double charge_181_infinity_if_above_60kWh = 9.40;
        ...
        double fixed_charge_181_infinity_if_above_60kWh = 240.00;
            ...
            if (int.TryParse(temp, out value))
            {
                ...
                if (units_consumed >= 0)
                {
                    ...
                    else if (units_consumed > 180)
                    {
                        ...
                        charge_above_180 = (units_consumed - 180) * charge_181_infinity_if_above_60kWh;
                        total_charge = charge_0_30 + charge_31_90 + charge_91_120 + charge_121_180 + charge_above_180 + fixed_charge_181_infinity_if_above_60kWh;
                        myMethod(fixed_charge_181_infinity_if_above_60kWh);
                        tableLayoutPanel1.Visible = true;
                        tb_unit.Text = "";
                    }
        ...
        private void frm_rel_cat_R_1_Load(object sender, EventArgs e)
        {
            ...
            lbl_t_5.Text = charge_181_infinity_if_above_60kWh.ToString();
            ...
            lbl_t_10.Text = fixed_charge_181_infinity_if_above_60kWh.ToString();
        }
    }
}
